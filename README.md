...
```bash
python3 -m venv .venv
.venv/bin/python -m pip install -e './reference/checkpoints/module-04/lesson-05[dev]'
```
...
```bash
.venv/bin/python -m pytest -q tests reference/checkpoints/module-04/lesson-05/tests
