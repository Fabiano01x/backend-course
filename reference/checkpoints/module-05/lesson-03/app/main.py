...
- os cadastros HTTP ainda permanecem em memória;
- a aplicação já gerencia conexão e sessões assíncronas de PostgreSQL;
    ...
    async def lifespan(_: FastAPI) -> AsyncIterator[None]:
        try:
            async with database.engine.begin() as connection:
                # Ponte didática temporária: Alembic substituirá create_all.
