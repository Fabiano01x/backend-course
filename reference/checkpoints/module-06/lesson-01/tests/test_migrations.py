...
def test_revision_history_has_one_auditable_head() -> None:
    ...
    assert head == "0002_user_password_hash"
    assert revision is not None
    assert revision.down_revision == "0001_library_schema"
    assert revision.doc == "Adiciona hash opcional para credenciais locais."
