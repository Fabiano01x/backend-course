...
def test_revision_history_has_one_auditable_head() -> None:
    ...
    assert head == "0005_oidc_identities"
    assert revision is not None
    assert revision.down_revision == "0004_role_assignments"
    assert revision.doc == "Cria tentativas OIDC e vínculos de identidades externas."
