...
def test_revision_history_has_one_auditable_head() -> None:
    ...
    assert head == "0003_refresh_token_rotation"
    assert revision is not None
    assert revision.down_revision == "0002_user_password_hash"
    assert revision.doc == "Cria famílias rotativas de refresh tokens."
