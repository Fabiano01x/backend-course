...
from app.schemas import BookCreate, BookPage, BookResponse, ErrorResponse
...
@router.get(
    ...
    description="Filtra, ordena e pagina o acervo disponível em memória.",
...
@router.post(
    ...
    description="Cria um livro disponível no acervo temporário.",
